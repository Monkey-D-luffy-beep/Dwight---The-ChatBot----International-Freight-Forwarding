"""
Lead capture — saves qualified leads to Google Sheets / email / local fallback.
"""
...
async def _send_lead_notification(
    ...
    try:
        ...
        body = f"""
New Lead Captured from Green Time Marine Time Chatbot
...
---
This is an automated notification from Dwight.
        """
