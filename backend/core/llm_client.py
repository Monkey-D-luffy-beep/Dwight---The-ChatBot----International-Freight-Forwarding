"""
Groq LLM client — loads system prompts, sends completions, caches where possible.
"""
...
def get_default_prompt(intent: IntentType) -> str:
    ...
    base = """You are a helpful assistant for Green Time Marine Time (GTMT), an international freight forwarding company.
...
async def generate_response(
    ...
    try:
        ...
        return "I'm having trouble processing your request right now. Please try again or contact us at info@greentimemarinetime.in for assistance."
