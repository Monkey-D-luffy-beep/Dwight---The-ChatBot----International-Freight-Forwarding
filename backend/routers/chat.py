"""
Chat router — handles /api/chat and /api/lead endpoints.
"""
...
class ChatRequest(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "message": "What services does Green Time Marine Time offer?",
                "session_id": "user-123"
            }
        }
...
class ChatResponse(BaseModel):
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "response": "Green Time Marine Time offers FCL shipping, LCL shipping, air freight, cold chain logistics, project cargo, and customs clearance services.",
                "intent": "support",
                "lead_prompt": False,
...
async def submit_lead(request: LeadCaptureRequest):
    ...
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Unable to process your request. Please contact us directly at info@greentimemarinetime.in"
        )
